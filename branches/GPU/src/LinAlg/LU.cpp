...
namespace BOOM{
  namespace LinAlg{
	...
	throw std::logic_error("LU:: determinant of non-square Matrix attempted.");
    ...
    Matrix LU::solve(const Matrix &B)const{
      ...
      if(info!=0) throw std::logic_error("LU::solve illegal argument to dgetrs_");
      return ans;
    }
    ...
    Matrix LU::solveT(const Matrix &B)const{
      ...
      if(info!=0) throw std::logic_error("LU::solveT illegal argument to dgetrs_");
      return ans;
    }
