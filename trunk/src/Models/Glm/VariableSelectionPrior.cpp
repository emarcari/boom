...
#include "VariableSelectionPrior.hpp"
...
namespace BOOM{
  ...
  void VSP::add_missing_main_effect(uint pos, double prob , uint oi_pos, const string &name){
  ...
  void VSP::add_interaction(uint pos, double prob, const std::vector<uint> & parents, const string &name){
