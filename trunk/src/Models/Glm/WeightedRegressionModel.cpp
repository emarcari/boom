...
#include "WeightedRegressionModel.hpp"
...
//   regression_params * WRS::ols()const{
//     Vec b = beta_hat();
//     double n = this->n();
//     double p = size();
//     double sigsq = SSE()/(n-p);
//     return new regression_params(b, sigsq);}
