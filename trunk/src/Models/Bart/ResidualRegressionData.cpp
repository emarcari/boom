...
namespace BOOM {
  namespace Bart {
    ...
    //----------------------------------------------------------------------
    void ResidualRegressionData::add_to_gaussian_suf(GaussianBartSufficientStatistics &)const {
      report_error("Illegal combination of ResidualRegressionData with "
                   "GaussianBartSufficientStatistics.");
    }

    //----------------------------------------------------------------------
    void ResidualRegressionData::add_to_poisson_suf(PoissonSufficientStatistics &)const {
      report_error("Illegal combination of ResidualRegressionData with "
                   "PoissonSufficientStatistics.");
    }

    //----------------------------------------------------------------------
    void ResidualRegressionData::add_to_probit_suf(ProbitSufficientStatistics &)const {
      report_error("Illegal combination of ResidualRegressionData with "
                   "ProbitSufficientStatistics.");
    }

    //----------------------------------------------------------------------
    void ResidualRegressionData::add_to_logit_suf(LogitSufficientStatistics &)const {
      report_error("Illegal combination of ResidualRegressionData with "
